...
describe('Ciclos CRUD no Banco de Dados', () => {
  ...
  it('Deve retornar mensagem ao tentar cadastrar categoria com nome já existente', done => {
    chai.request('http://localhost:3000')
      .post('/v1/categories')
      ...
      .end((err, res) => {
        ...
        res.body.response.message.should.be.eql('Não é possível cadastrar categoria com nome que já existe no sistema.');
        done();
      });
  });

  it('Deve retornar mensagem ao tentar cadastrar categoria com descrição já existente', done => {
    chai.request('http://localhost:3000')
      .post('/v1/categories')
      ...
      .end((err, res) => {
        ...
        res.body.should.be.a('object');
        res.body.response.message.should.be.a('string');
        res.body.response.message.should.be.eql('Não é possível cadastrar categoria com descrição que já existe no sistema.');
        done();
      });
  });
  ...
  it('Deve retornar mensagem ao tentar excluir categoria 2 através da rota deleteCategory', done => {
    chai.request('http://localhost:3000')
      ...
      .end((err, res) => {
        ...
        res.body.should.be.a('object');
        res.body.response.message.should.be.a('string');
        res.body.response.message.should.be.eql('Não é possível excluir uma categoria que tenha carros cadastrados nela.');
        done();
      });
  });
